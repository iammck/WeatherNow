...
The OpenWeatherMap API key has changed. You will need to get your own key and replace it in the necessary file in order to run the application successfully. Thank you for your appreciation.
